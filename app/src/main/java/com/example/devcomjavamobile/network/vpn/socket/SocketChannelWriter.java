...
* https://github.com/httptoolkit/httptoolkit-android/blob/master/app/src/main/java/tech/httptoolkit/android/vpn/socket/SocketChannelWriter.java
*/
...
public class SocketChannelWriter {
    private final String TAG = SocketChannelWriter.class.getSimpleName();

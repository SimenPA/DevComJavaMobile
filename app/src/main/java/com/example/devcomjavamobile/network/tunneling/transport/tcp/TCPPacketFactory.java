...
package com.example.devcomjavamobile.network.tunneling.transport.tcp;
...
/*
* Imported by Simen Persch Andersen on 26.03.2021 from
* https://github.com/httptoolkit/httptoolkit-android/blob/master/app/src/main/java/tech/httptoolkit/android/vpn/transport/tcp/TCPPacketFactory.java
 */
public class TCPPacketFactory {

    //TODO: Fix this
    private static final String TAG = TCPPacketFactory.class.getSimpleName();
